...
namespace PReMaSys.Controllers
{
    ...
    public class SupportAdminController : Controller
    {
        ...
        public async Task<ActionResult> SERecord(SalesUser se) //Good
        {
            ...
            var autoGenPassW = GeneratePassword();
            await _userManager.AddPasswordAsync(user, autoGenPassW);
            ...
            if (result.Succeeded)
            {
                ...
                //Email
                    await _emailSender.SendEmailAsync(se.Email, "Confirm your email",
                      ...
                      $"                            Greetings and welcome to PReMaSys!" +
                      $"                        </span>\r\n                        " +
                      $"                        <div style=padding:5px></div>\r\n                        " +
                      $"                        <div style=\"font-family: inherit; text-align: inherit; margin-left: 0px\">" +
                      $"                            <span style=\"color: #294661; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Helvetica, Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 300; letter-spacing: normal; orphans: 2; text-align: start; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; box-sizing: border-box; width: 518px; -webkit-border-horizontal-spacing: 0px; -webkit-border-vertical-spacing: 0px; border-collapse: separate; margin-top: 0px; margin-right: 0px; margin-bottom: 30px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; vertical-align: top\">  " +
                      $"                                We’re so happy that you’re here and can’t wait to help you reach your goals when it comes to managing your sales employees, " +
                      $"                                tracking their performance, boosting their morale, and recognizing their efforts. We can’t wait to finally have you in our community, " +
                      $"                                but first, there are a few pre-screening steps you must complete to get started with the web application. You can start by doing this task." +
                      $"                            </span>&nbsp;</div><div></div>\r\n                        " +
                      ...
                      $"                        <div style=\"font-family: inherit; text-align: inherit; margin-left: 0px\">" +
                      $"                            <span style=\"color: #294661; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Helvetica, Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 300; letter-spacing: normal; orphans: 2; text-align: start; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; box-sizing: border-box; width: 518px; -webkit-border-horizontal-spacing: 0px; -webkit-border-vertical-spacing: 0px; border-collapse: separate; margin-top: 0px; margin-right: 0px; margin-bottom: 30px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; vertical-align: top\">  " +
                      $"                               The password provided will be used for newly registered users." +
                      $"                               <br>" +
                      $"                               Users can change their password by logging in first and navigating to the Manage Account section." +
                      $"                               <br>" +
                      $"                               <br>" +
                      $"                               Your auto-generated password is: {HtmlEncoder.Default.Encode(autoGenPassW)}" +                    
                      $"                            </span>&nbsp;</div><div></div>\r\n                        " +
                      ...
                      $"                            © PreMaSys Inc. 2544 Taft Ave, Malate, Manila, 1004 Metro Manila" +
                      $"                        </span>" +
                      $"                    </div>" +
                      $"                    <div>" +
                      $"                    </div>" +
        ...
        private string GeneratePassword()
        {
            ...
            const string allChars = uppercaseChars + lowercaseChars + specialChars + "0123456789";
            for (int i = 0; i < 7; i++)
            {
